	...
	<div class="container556">
	   <h1>Personal Information</h1>
        <div class="rider-info">
            ...
            <p id="rider-name">Marc Patrick Mintal Aurea</p>
			<br>
			<label for="rider-phone">Address:</label>
            <p id="rider-phone">69 Di malaman st. Brgy. Dito, Dyan city.</p>
			<br>
            <label for="rider-phone">Contact Number:</label>
            <p id="rider-phone">09136877090</p>
			<br>
            <label for="rider-license">Email Address:</label>
            <p id="rider-license">Marcpatrickmintalaurea@ewankosayo.com</p>
        </div>
    </div>
	<br><br><br><br><br>
	<center>
